...
/* Private defines -----------------------------------------------------------*/
#define HALL_SENSOR_U_Pin GPIO_PIN_0
#define HALL_SENSOR_U_GPIO_Port GPIOA
#define HALL_SENSOR_V_Pin GPIO_PIN_1
#define HALL_SENSOR_V_GPIO_Port GPIOA
#define HALL_SENSOR_W_Pin GPIO_PIN_2
#define HALL_SENSOR_W_GPIO_Port GPIOA
#define VBUS_ADC_Pin GPIO_PIN_4
#define VBUS_ADC_GPIO_Port GPIOA
#define MOSFET_TEMP_ADC_Pin GPIO_PIN_5
#define MOSFET_TEMP_ADC_GPIO_Port GPIOA
#define MOTOR_TEMP_ADC_Pin GPIO_PIN_6
#define MOTOR_TEMP_ADC_GPIO_Port GPIOA
#define THROTTLE_ADC_Pin GPIO_PIN_7
...
#define DIRECTION_BUTTON_Pin GPIO_PIN_3
#define DIRECTION_BUTTON_GPIO_Port GPIOB
#define DIRECTION_BUTTON_EXTI_IRQn EXTI3_IRQn
#define BRAKE_BUTTON_Pin GPIO_PIN_5
#define BRAKE_BUTTON_GPIO_Port GPIOB
#define BRAKE_BUTTON_EXTI_IRQn EXTI9_5_IRQn
